...
$total+=$value['item_price']*$value['quantity'];
 ...
 ?>
								<tr class="table_row">
									<td class="column-1">
										<div class="">
											<form class="" action="cartremove.php" method="post">
									...
									<td class="column-2"><?php echo htmlentities($value['item_name']); ?></td>
									<td class="column-3">$<?php echo htmlentities($value['item_price']); ?>.00</td>
									<td class="column-4">
										<form class="" action="cartupdate.php" method="post">
									...
									<td class="column-5"><button class="btn btn-sm btn-outline-danger" name = "update">Update</button>
									<input type="hidden" name="item_name" value="<?php echo $value['item_name']; ?>">
									</form></td>
								</tr>
<?php 	} } ?>
